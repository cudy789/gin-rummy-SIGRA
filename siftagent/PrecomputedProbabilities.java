...
public class PrecomputedProbabilities{
    public static void main(String[] args) {
        ...
        try {
            ...
            BufferedReader filereader = new BufferedReader(new FileReader("precomputed_probabilities.csv"));
            ...
            int power_size = 11;
            double[][][] precomputed_probabilities = new double[numerator_size][denominators_size][power_size];
