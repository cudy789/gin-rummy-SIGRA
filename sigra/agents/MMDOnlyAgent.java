...
public class MMDOnlyAgent extends NaiveDeadwoodMinimizingAgent {
  ...
  private MMDOnlyAgent(double SecondOrderWeight) {
    super();
    this.SECOND_ORDER_REDUCTION_WEIGHT = SecondOrderWeight;
    this.TRY_TO_PREDICT_OPPONENT_MELDS = false;
  }

  private MMDOnlyAgent(double SecondOrderWeight, double OppMeldsWeight) {
    super();
    this.SECOND_ORDER_REDUCTION_WEIGHT = SecondOrderWeight;
    this.TRY_TO_PREDICT_OPPONENT_MELDS = false;
