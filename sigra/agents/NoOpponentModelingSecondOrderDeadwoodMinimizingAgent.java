...
public class NoOpponentModelingSecondOrderDeadwoodMinimizingAgent extends NaiveDeadwoodMinimizingAgent {
  ...
  boolean TRY_TO_PREDICT_OPPONENT_MELDS = false;
    ...
    public NoOpponentModelingSecondOrderDeadwoodMinimizingAgent() {
        super();
    }

  private NoOpponentModelingSecondOrderDeadwoodMinimizingAgent(double SecondOrderWeight) {
    super();
    this.SECOND_ORDER_REDUCTION_WEIGHT = SecondOrderWeight;
    this.TRY_TO_PREDICT_OPPONENT_MELDS = false;
  }

  private NoOpponentModelingSecondOrderDeadwoodMinimizingAgent(double SecondOrderWeight, double OppMeldsWeight) {
    super();
    this.SECOND_ORDER_REDUCTION_WEIGHT = SecondOrderWeight;
    this.TRY_TO_PREDICT_OPPONENT_MELDS = false;
