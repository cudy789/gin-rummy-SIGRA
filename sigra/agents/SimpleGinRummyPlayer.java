 ...
 * Ignore opponent actions and cards no longer in play. Draw face up card only if it becomes part of
 * a meld. Draw face down card otherwise. Discard a highest ranking unmelded card without regard to
 * breaking up pairs, etc. Knock as early as possible.
 *
 * @author Todd W. Neller
 * @version 1.0
 *     <p>Copyright (C) 2020 Todd Neller
 ...
 *     <p>Information about the GNU General Public License is available online at:
 *     http://www.gnu.org/licenses/ To receive a copy of the GNU General Public License, write to
  ...
  public Card getDiscard() {
    ...
    for (Card card : cards) {
      ...
      ArrayList<ArrayList<ArrayList<Card>>> bestMeldSets =
          GinRummyUtil.cardsToBestMeldSets(remainingCards);
      int deadwood =
